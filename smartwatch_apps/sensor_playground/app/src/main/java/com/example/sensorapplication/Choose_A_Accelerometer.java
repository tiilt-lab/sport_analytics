...
public class Choose_A_Accelerometer extends WearableActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_choose__a__accelerometer);
...
/*        xBtn.setOnClickListener(new View.OnClickListener() {
        ...
        magBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Choose_A_Accelerometer.this, Accelerometer.class);
